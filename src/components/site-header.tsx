      ...
      {open && (
        <div className="border-t border-border bg-background lg:hidden">
          <nav className="flex flex-col gap-1 px-4 py-4">
            ...
            <a href={`https://wa.me/${site.whatsapp.replace(/\D/g, "")}`} className="mt-2 rounded-full px-4 py-2.5 text-center text-sm font-semibold text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
